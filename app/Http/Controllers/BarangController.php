...
class BarangController extends Controller
{
    ...
    {
        $update = \App\Barang::findOrfail($id);
        $update->kd_brg=$request->get('addkdbrg');
        $update->nm_brg=$request->get('addnmbrg');
        $update->harga=$request->get('addharga');
        $update->stok=$request->get('addstok');
        $update->save();
